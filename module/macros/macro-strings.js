export function itemMacroString(item) {
  const content =
    ...
    // Change the values after the equal sign, and uncomment the line.
    ...
    game.cyphersystem.itemRollMacro(actor, "${item}", options)`;
